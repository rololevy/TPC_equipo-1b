...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="d-flex justify-content-center align-items-center mt-4">
        <div class="card p-4 border-1 text-white" style="min-width:400px; background: linear-gradient(135deg, #0d6efd, #5fa8ff); border-radius: 15px;">
            <h1 class="textCenter mb-4 tex-primary fw-bold"> Agregar Cliente</h1>
            <div class="mb-3">
                <asp:Label ID="lblNombre" CssClass="form-label" runat="server" Text="Nombre del cliente"></asp:Label>
                <asp:TextBox ID="txtNombre" CssClass="form-control" placeholder="ingrese el nombre" runat="server"></asp:TextBox>
            </div>
            <div class="mb-3">
                <asp:Label ID="lblApellido" CssClass="form-label" runat="server" Text="Apellido del cliente"></asp:Label>
                <asp:TextBox ID="txtApellido" CssClass="form-control" placeholder="Ingrese el apellido" runat="server"></asp:TextBox>
            </div>
            <div class="mb-3">
                <asp:Label ID="lblDni"  CssClass="form-label" runat="server" Text="Dni del cliente"></asp:Label>
